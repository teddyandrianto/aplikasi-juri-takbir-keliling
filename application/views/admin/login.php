...
<body>
    ...
    <?=$this->session->flashdata('pesan')?>   
        <div id="loginbox" style="margin-top:0px;" class="mainbox col-md-4 col-md-offset-4 ">                    
            <div class="panel panel-success" >
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" class="form-horizontal" action="<?php echo base_url('index.php/administrator/login')?>" method= "POST"  role="form" >
