...
<div class="col-xs-12">
          <div class="box">
            ...
            <br>
              ...
              <br>
              <div class="col-md-3 ">
              <h5><b>Nama Juri&nbsp;&nbsp;&nbsp;:</b>&nbsp;<?php echo $_SESSION['sesijuri']['nama']?></h5>
              <h5><b>Perwakilan&nbsp;:</b>&nbsp;<?php echo $_SESSION['sesijuri']['perwakilan']?></h5>
              ...
              <div class="col-md-1 aksi">
                 ...
                 <div class="col-md-2 col-lg-offset-7" > <h5><b>ID Juri&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b>&nbsp;<?php echo $_SESSION['sesijuri']['id']?></h5>
                </div>
     ...
     <div class="col-xs-3 pull-right">
              ...
              <br>
              <br>
              <h5 class="box-title "><B>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<?php echo $_SESSION['sesijuri']['nama']?>)</b></h5>
              </center>
              </div>
          </div>
        </div>
